...
> [← 上一篇：Bluetooth Audio](14_Bluetooth_Audio.md) | [返回导航](README.md) | [下一篇：Vendor+QNX双域架构 →](16_Vendor_QNX_Architecture.md)

---

## 目录

- [15.1 PAL 概述](#15.1-pal-概述)
- [15.2 整体架构与层次关系](#15.2-整体架构与层次关系)
- [15.3 PAL API 层](#15.3-pal-api-层)
- [15.4 类型定义体系](#15.4-类型定义体系)
- [15.5 Stream 类层次](#15.5-stream-类层次)
- [15.6 Device 类层次](#15.6-device-类层次)
- [15.7 Session 类层次](#15.7-session-类层次)
- [15.8 ResourceManager 资源管理器](#15.8-resourcemanager-资源管理器)
- [15.9 PayloadBuilder 载荷构建器](#15.9-payloadbuilder-载荷构建器)
- [15.10 IPC 机制](#15.10-ipc-机制)
- [15.11 XML 配置体系](#15.11-xml-配置体系)
- [15.12 HAL-PAL 适配层](#15.12-hal-pal-适配层)
- [15.13 Plugins 插件体系](#15.13-plugins-插件体系)
- [15.14 Utils 工具集](#15.14-utils-工具集)
- [15.15 ContextManager 上下文管理](#15.15-contextmanager-上下文管理)
- [15.16 SndCardMonitor 声卡监控](#15.16-sndcardmonitor-声卡监控)
- [15.17 核心流程分析](#15.17-核心流程分析)
...
> 在AudioReach架构下，PAL Session通过AGM API与GSL交互；SA8295上AGM调用GSL API由gsl_fe代理经MM-HAB跨VM转发给QNX侧gsl_vm_be执行；Legacy架构下直接调用GSL API。详见[16.10 AGM深度解析](16_Vendor_QNX_Architecture.md)和[16.14 GSL内部架构](16_Vendor_QNX_Architecture.md)。
