...
> [← 上一篇：Vendor+QNX双域架构](16_Vendor_QNX_Architecture.md) | [返回导航](README.md)

---

O.1 dumpsys audio — 音频系统全量状态
...
O.13.1 EffectChain Dump解读

EffectChain dump格式（源码：[`Effects.cpp`](frameworks/av/services/audioflinger/Effects.cpp)）：
...
O.15 AudioFlinger Tunable参数

O.15.1 Property调试开关列表
...
|----------|--------|------|----------|
| `af.fast_track_multiplier` | 无(代码计算) | Fast Track数量倍数 | [`Threads.cpp`](frameworks/av/services/audioflinger/Threads.cpp) |
| `af.thread.throttle` | true | 线程节流开关 | [`Threads.cpp`](frameworks/av/services/audioflinger/Threads.cpp) |
| `af.patch_park` | false | Patch暂停调试 | [`Threads.cpp`](frameworks/av/services/audioflinger/Threads.cpp) |
| `af.tee` | 0(非debugable) | NBAIO Tee数据记录 | [`NBAIO_Tee.h`](frameworks/av/services/audioflinger/NBAIO_Tee.h) |
| `ro.audio.max_fast_tracks` | 无 | 最大Fast Track数 | [`FastMixerState.cpp`](frameworks/av/services/audioflinger/FastMixerState.cpp) |
| `ro.audio.flinger_standbytime_ms` | 无 | AF待机超时(ms) | [`AudioFlinger.cpp`](frameworks/av/services/audioflinger/AudioFlinger.cpp) |
| `ro.af.client_heap_size_kbyte` | 0(默认) | 客户端堆大小(KB) | [`AudioFlinger.cpp`](frameworks/av/services/audioflinger/AudioFlinger.cpp) |
| `ro.audio.silent` | 0 | 静音模式(调试用) | [`Threads.cpp`](frameworks/av/services/audioflinger/Threads.cpp) |
| `ro.audio.offload_wakelock` | true | Offload wakelock开关 | [`Threads.cpp`](frameworks/av/services/audioflinger/Threads.cpp) |

**AAudio相关Property**：

| Property | 默认值 | 说明 | 源码位置 |
|----------|--------|------|----------|
| `aaudio.mmap_policy` | NEVER(1) | MMAP策略(1=NEVER,2=AUTO,3=ALWAYS) | [`PropertyUtils.cpp`](frameworks/av/services/audioflinger/PropertyUtils.cpp) |
| `aaudio.mmap_exclusive_policy` | UNSPECIFIED | MMAP Exclusive策略 | [`PropertyUtils.cpp`](frameworks/av/services/audioflinger/PropertyUtils.cpp) |
| `aaudio.mixer_bursts` | 2 | AAudio Mixer burst数 | [`PropertyUtils.cpp`](frameworks/av/services/audioflinger/PropertyUtils.cpp) |
| `aaudio.hw_burst_min_usec` | 1000 | 硬件burst最小时长(μs) | [`PropertyUtils.cpp`](frameworks/av/services/audioflinger/PropertyUtils.cpp) |
